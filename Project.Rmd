...
ASE_ARMA_L = mean((df_test_l$home_price[(length(df_test_l$home_price)-60+1)] - preds$f)^2)
...
ASE_ARIMA_L = mean((df_test_l$home_price[(length(df_test_l$home_price)-60+1)] - preds_ARIMA_L$f)^2)
...
ASE_ARUMA_L = mean((df_test_l$home_price[(length(df_test_l$home_price)-60+1)] - preds$f)^2)
...
ASE_ENSEMBLE_L
# 5234559708
# ARIMA has the smallest ASE for long-term forecast: 62540456

# TODO: show for "best" models short/long term plot of predicted prices versus real prices

# 6. Provide the forecasts and prediction limits (when possible) for both the short and long term forecasts. 

# TODO: identify a short term and a long term model and probably train it on entire data set (instead of test set) then forecast
