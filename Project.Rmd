...
ASE = mean((df_test_s$home_price[1:6]-forecast_mlp_short$mean)^2)
ASE
...
mlp_fit_long = mlp(home_price_ts_train_l, xreg = data.frame(cpi = cpi_ts_train_l, unemp = unemp_ts_train_l))
...
lines(seq(1,60),forecast_mlp_long$mean, col = "blue")
ASE = mean((df_test_l$home_price[1:60]-forecast_mlp_long$mean)^2)
ASE

# TODO: JAE
# 4d. Fitting Ensemble model using at least two of the above. 
ensemble = (preds_var_l$fcst$cpi[,1] + forecast_mlp_long$mean)/2
ensemble
