...
#Compare Spectral Densities ARMA(1,0)

sims = 5
SpecDen = parzen.wge(df_train_s$home_price, plot = "FALSE")
plot(SpecDen$freq,SpecDen$pzgram, type = "l", lwd = 6)

for( i in 1: sims)
{
   SpecDen2 = parzen.wge(gen.arma.wge(200, phi = est.hp$phi, theta = est.hp$theta, plot = "FALSE"), plot = "FALSE")
...
#Compare Spectral Densities ARIMA(2,1,3)
...
for( i in 1: sims)
{
   SpecDen2 = parzen.wge(gen.aruma.wge(200,d = 1, phi = est.hp.d1$phi, theta = est.hp.d1$theta, plot = "FALSE"), plot = "FALSE")
   lines(SpecDen2$freq,SpecDen2$pzgram, lwd = 2, col = "red")
}
...
#Compare Spectral Densities ARIMA(2,1,3) s = 12
...
for( i in 1: sims)
{
   SpecDen2 = parzen.wge(gen.aruma.wge(200,d = 1, s = 12, phi = est.hp.12$phi, theta = est.hp.12$theta, plot = "FALSE"), plot = "FALSE")
   lines(SpecDen2$freq,SpecDen2$pzgram, lwd = 2, col = "red")
}
